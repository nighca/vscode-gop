...
import { disposeGoStatusBar, expandGoStatusBar, outputChannel, updateGoStatusBar } from './goStatusWeb';
...
import extensionAPI from './extensionAPIWeb';
...
import * as commands from './commands/web';
