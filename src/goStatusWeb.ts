...
import { formatGoVersion, GoEnvironmentOption, terminalCreationListener } from './goEnvironmentStatusWeb';
...
import { getGoVersion } from './utilWeb';
import { GoExtensionContext } from './context';
import { CommandFactory } from './commands/web';
